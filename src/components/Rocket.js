...
<div className="details--left">
    <p>name:
        <span id="name">falcon1</span>
    </p>
    <p>company:
        <span id="company">falcon1</span>
    </p>
    <p>height:
        <span id="height">falcon1</span>
    </p>
    <p>diameter:
        <span id="diameter">falcon1</span>
    </p>
    <p>mass:
        <span id="mass">falcon1</span>
    </p>
</div>
<div className="details--right">
    <p>first flight:
        <span id="first-flight">falcon1</span>
    </p>
    <p>country:
        <span id="success-rate">falcon1</span>
    </p>
    <p>success rate:
        <span id="height">falcon1</span>
    </p>
    <p>cost per launch:
        <span id="cost">falcon1</span>
    </p>
</div>
